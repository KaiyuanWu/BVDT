...
//    cout<<"split node("<<_root_node->_left_data_index<<", "<<_root_node->_right_data_index<<")!"<<endl;
    ...
    for(int i=1; i<_nleaves; i++){
        ...
        _nleaves_1--;
//        cout<<"split node("<<node->_left_child->_left_data_index<<", "<<node->_left_child->_right_data_index<<")"<<endl;
        split_node_full_search(node->_left_child);
//        cout<<"split node("<<node->_right_child->_left_data_index<<", "<<node->_right_child->_right_data_index<<")"<<endl;
...
//        cout<<"rearrange:("<<left<<", "<<right<<", "<<best_split<<", "<<best_feature_index<<")"<<endl;
    }
...
void Tree::split_node_alternative(Node* node){
    ...
    //fix node mode
//    cout<<"_effective_feature_number:\t"<<_effective_feature_number<<endl;
//    cout<<"left:\t"<<left<<", right:\t"<<right<<endl;
    for(int i1 = 0; i1<_effective_feature_number; i1++){
        ...
        for(int i2= left; i2< right; i2++){
            ...
            float split_gain = gain_left + gain_right - gain;
//            cout<<"========================================="<<endl;
//            cout<<"split_gain:\t"<<split_gain<<endl;
//            cout<<"best_split_gain:\t"<<best_split_gain<<endl;
//            cout<<"best_feature:\t"<<best_feature<<endl;
//            cout<<"best_feature_index:\t"<<best_feature_index<<endl;
            if(split_gain > best_split_gain){
                best_split_gain = split_gain;
                best_feature = ifeature;
                best_feature_index = i1;
