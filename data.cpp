...
//    for(int i=0; i<_nfeatures; i++){
//        for(int j=0; j<_ntrain_samples; j++){
//            cout<<_train_data[_data_reverse_order_0[i][j]*_nfeatures+i]<<"\t";
//        }
//        cout<<endl;
//    }
...
//        cout<<_train_loss<<",\t"<<_train_p[index+_train_labels[i]]<<",\t"<<index<<",\t"<<_train_labels[i]<<endl;
//        for(int j=0; j<_nclasses; j++)
//            cout<<_train_f[index+j]<<", ";
//        cout<<":\t"<<_train_labels[i]<<"\t"<<-log(_train_p[index+_train_labels[i]])<<endl;
    }
//    exit(0);
...
//                cout<<"["<<i<<", "<<_test_labels[i]<<"->"<<maxi<<"] ";
//                cout<<"p= (";
//                for(int j=0; j<_nclasses; j++)
//                    cout<<_test_p[index + j]<<", ";
//                cout<<") ";
//                cout<<endl;
            }
